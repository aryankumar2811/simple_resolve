...
function OutcomeBadge({ client }: { client: SimClientState }) {
  ...
  const labels: Record<number, { label: string; cls: string }> = {
    0: { label: 'L0 — Auto-resolved', cls: 'text-emerald-700 bg-emerald-50 border-emerald-200' },
    1: { label: 'L1 — Monitoring', cls: 'text-blue-700 bg-blue-50 border-blue-200' },
    2: { label: 'L2 — Minor Freeze', cls: 'text-amber-700 bg-amber-50 border-amber-200' },
    3: { label: 'L3 — Investigation', cls: 'text-orange-700 bg-orange-50 border-orange-200' },
    4: { label: 'L4 — Full Freeze', cls: 'text-red-700 bg-red-50 border-red-200' },
  }
...
export default function SimulationModal() {
  const { isModalOpen, clients, activeClientIndex, allComplete, isRunning, closeModal } = useSimulation()
